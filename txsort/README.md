...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/cbarraford/btcutil/txsort)
...
```bash
$ go get -u github.com/cbarraford/btcutil/txsort
```

...
import (
	...
	"github.com/coinsuite/coinutil/coinset"
)
...
var (
	...
	testSimpleCoinTxValue0            = coinutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = coinutil.NewTxFromBytes(testSimpleCoinTxBytes)

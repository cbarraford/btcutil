...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/coinsuite/coinutil/coinset)
...
```bash
$ go get -u github.com/coinsuite/coinutil/coinset
```

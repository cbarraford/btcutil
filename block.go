...
// Tx returns a wrapped transaction (coinutil.Tx) for the transaction at the
...
// Transactions returns a slice of wrapped transactions (coinutil.Tx) for all
...
// instead provides easy access to wrapped versions (coinutil.Tx) of them.
